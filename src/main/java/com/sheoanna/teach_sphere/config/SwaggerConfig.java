    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                ...
                .components(new Components()
                        ...
                        .addResponses("MentorSubjectNotFound", apiResponse(404, "Mentor Subject not found."))
                        .addResponses("MentorSubjectReviewNotFound", apiResponse(404, "Mentor Subject Review not found."))
